...
export function ContactFormModal({
  ...
  useEffect(() => {
    ...
    if (document.querySelector(`script[src="${HIGHLEVEL_FORM_SCRIPT}"]`))
      return;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!data.consent || isSubmitting) return;
    setSubmitError(null);
  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="hp-cfm-title">{villaName ? villaName : "Hola Paje"}</h2>
        ...
        {isBrochureGate ? (
          <div
            className="hp-cfm-form"
            style={{ position: "relative", zIndex: 10021 }}
          >
            <iframe
          ...
          <form className="hp-cfm-form" onSubmit={handleSubmit} noValidate>
            ...
            <div className="hp-cfm-field hp-cfm-field--full">
              <label htmlFor="cfm-message">
                Message <span className="hp-cfm-optional">(optional)</span>
              </label>
              <textarea
                id="cfm-message"
                rows={3}
            ...
            <label className="hp-cfm-consent">
              ...
              />
              <span>
                I agree to be contacted by the Hola Paje team regarding this
            ...
            {submitError && <p className="hp-cfm-error">{submitError}</p>}
